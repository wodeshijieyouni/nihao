...
.u_logo{
	background: url("/erqi/Public/images/username.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 43px;
	left: 40px;
...
.p_logo{
	background: url("/erqi/Public/images/password.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 12px;
	left: 40px;
...
.tou{
	background: url("/erqi/Public/images/tou.png") no-repeat;
	width: 97px;
	height: 92px;
	position: absolute;
	top: -87px;
...
.left_hand{
	background: url("/erqi/Public/images/left_hand.png") no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
	top: -38px;
...
.right_hand{
	background: url("/erqi/Public/images/right_hand.png") no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
	top: -38px;
...
.initial_left_hand{
	background: url("/erqi/Public/images/hand.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -12px;
...
.left_handing{
	background: url("/erqi/Public/images/left-handing.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -24px;
...
.right_handinging{
	background: url("/erqi/Public/images/right_handing.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -21px;
...
class="u_logo"></SPAN>        <form method="post" action="/erqi/index.php/Admin/Public/doLogin"><INPUT class="ipt" type="text" placeholder="请输入用户名或邮箱" value="" name="user_name"> 
    </P>
<P style="position: relative;"><SPAN class="p_logo"></SPAN>         
<INPUT class="ipt" id="password" type="password" placeholder="请输入密码" value="" name="user_pass">  
