...
<body>
    ...
    <script type="text/javascript">
        function fun(){
            window.location = "/erqi/index.php/Home/Car/dingdan";
        }
        function funn(a){
            $.ajax({
        ...
        <div class="box-hd">
            <div class="filter-lists">
                <ul>
                    ...
                    <li ><a href="/erqi/index.php/Home/List/search/desc/1/keyword/<?php echo ($key); ?>" rel="nofollow">价格从高到低</a>|</li>
                    <li ><a href="/erqi/index.php/Home/List/search/asc/1/keyword/<?php echo ($key); ?>" rel="nofollow">价格从低到高</a>|</li>
